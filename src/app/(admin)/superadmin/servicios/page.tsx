...
export default function ServicesPage() {
  ...
  const handleStatusChange = (service: SystemService) => {
    ...
    toast({ title: "Estado actualizado", description: `El servicio "${service.name}" ahora está ${newStatus}.` });
  };
  ...
  const onSubmit = (data: z.infer<typeof serviceSchema>) => {
    ...
    toast({ title: "Servicio Creado", description: `El servicio "${data.name}" ha sido creado.` });
    reset();
    setDialogOpen(false);
  };
